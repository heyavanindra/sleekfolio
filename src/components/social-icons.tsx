...
export const SocialIcons = {
  // Source: https://github.com/ncdai/chanhdai.com/blob/main/src/components/icons.tsx
  github: (props: IconProps) => (
    <svg viewBox="0 0 24 24" role="img" aria-label="GitHub" {...props}>
      <path
  ...
  linkedin: (props: IconProps) => (
    <svg viewBox="0 0 24 24" role="img" aria-label="LinkedIn" {...props}>
      <path
  ...
  resume: (props: IconProps) => (
    ...
    >
      ...
      />
      <path
        d="M13 3.75V8.5h5M9.75 12h4.5M9.75 15.5h3"
        stroke="currentColor"
        strokeLinecap="round"
        strokeLinejoin="round"
        strokeWidth="1.7"
  ...
  email: (props: IconProps) => (
    ...
    >
      ...
      />
      <path
        d="m4.75 7.5 6.35 5.1a1.45 1.45 0 0 0 1.8 0l6.35-5.1"
        stroke="currentColor"
        strokeLinecap="round"
        strokeLinejoin="round"
        strokeWidth="1.7"
